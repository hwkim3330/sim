...
(function(root, factory) {
    ...
    class I18nManager {
        ...
        t(key, params = {}) {
            ...
            if (value === undefined) {
                ...
                for (const k of keys) {
                    if (value && typeof value === 'object') {
                        ...
                        // Key not found in any language - warn and return key
                        console.warn(`[SimI18n] Missing translation key: "${key}"`);
                        return key;
                    }
                }
            }
            ...
            if (!foundInCurrent && this.currentLanguage !== this.fallbackLanguage) {
                console.debug(`[SimI18n] Using fallback for key: "${key}"`);
            }
    ...
    return {
        ...
        // Shorthand methods (delegate to instance)
