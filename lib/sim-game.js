 ...
 * Multi-Armed Bandit, MDP, Bayesian User Modeling
 * @version 1.0.0
 */
(function(root, factory) {
    ...
    class MultiArmedBandit {
        constructor(options = {}) {
            ...
            this.c = options.explorationParam || 2.0; // UCB exploration parameter

            // Beta distribution parameters for each arm
            this.alpha = new Array(this.numArms).fill(1); // successes + 1
            this.beta = new Array(this.numArms).fill(1);  // failures + 1
